...
namespace Aperiodic
{
    public class RecursiveDeflation : GH_Component
    {
        ...
        /// </summary>
        public RecursiveDeflation()
          : base("RecursiveDeflation", "RecDeflate",
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("B7E4F2A1-3C8D-4E5F-9A6B-1D2E3F4A5B6C");
    }
}
